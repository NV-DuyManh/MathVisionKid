        ...
        foreach ($conn in $conns) {
            ...
            if ($procId -and $procId -gt 0) {
                ...
                if ($p) {
                    ...
                    $isMathVision = ($cmdLine -match "MathVision|mathvisionkids|mathvision|backend[\\/]business-api|services[\\/]business-api|ai[\\/]runtime|services[\\/]ai-service|apps[\\/]|portal-web|teacher-web|admin-web|student-mobile|gradlew\.bat bootRun|expo|start:device") -or
                                    ($procPath -match "MathVision|services[\\/]ai-service|ai[\\/]runtime") -or
